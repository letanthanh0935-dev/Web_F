# Requirements - Đặc Sản Tây Nguyên
...
## 3. Trang Danh sách sản phẩm (`pages/san-pham.html`)
...
## 4. Trang Chi tiết sản phẩm (`pages/chi-tiet-san-pham.html`)
...
## 5. Trang Nguồn gốc sản phẩm (`pages/nguon-goc.html`)
...
## 6. Trang Liên hệ (`pages/lien-he.html`)
